...
public class Settings {
    ...
    static int savingOptionChoice = 1;
    ...
    public static void printSettings() {
        ...
        System.out.println("14. Type of saving the results (1-saving only values, 2-values with explanation): " + savingOptionChoice);
    ...
    //change saving options
    public static void changeSavingSettings() {
        while(true){
            System.out.println("Which saving option do you prefer?:");
            System.out.println("1. Saving only values");
            System.out.println("2. Saving values with their explanation");
            System.out.println("0. Exit");
            scanner.nextLine();
            boolean test = scanner.hasNextInt();
            if (test) {
                ...
                switch (SettingsChoice){
                    case 1:
                        savingOptionChoice = 1;
                        return;
                    case 2:
                        savingOptionChoice = 2;
                        return;
                    case 0:
                        return;
                    default:
    ...
    public static int getSavingOptionChoice () {return savingOptionChoice;}
}
